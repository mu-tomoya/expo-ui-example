        ...
        <Card modifiers={[fillMaxWidth()]}>
          <Column verticalArrangement={{ spacedBy: 12 }} modifiers={[padding(16, 16, 16, 16)]}>
            ...
            <ComposeText style={{ typography: "bodySmall" }} color="#666666">
              ...
              rounded shape with the clip modifier.
            </ComposeText>
            <HorizontalCenteredHeroCarousel itemSpacing={8} modifiers={[fillMaxWidth()]}>
              <Box
                modifiers={[size(300, 200), clip(Shapes.RoundedCorner(28)), background("#6200EE")]}
                contentAlignment="center"
              >
                <ComposeText color="#FFFFFF">1</ComposeText>
              </Box>
              <Box
                modifiers={[size(300, 200), clip(Shapes.RoundedCorner(28)), background("#03DAC5")]}
                contentAlignment="center"
              >
                <ComposeText color="#FFFFFF">2</ComposeText>
              </Box>
              <Box
                modifiers={[size(300, 200), clip(Shapes.RoundedCorner(28)), background("#FF5722")]}
                contentAlignment="center"
              >
                <ComposeText color="#FFFFFF">3</ComposeText>
              </Box>
              <Box
                modifiers={[size(300, 200), clip(Shapes.RoundedCorner(28)), background("#4CAF50")]}
                contentAlignment="center"
              >
                <ComposeText color="#FFFFFF">4</ComposeText>
              </Box>
              <Box
                modifiers={[size(300, 200), clip(Shapes.RoundedCorner(28)), background("#2196F3")]}
                contentAlignment="center"
              >
